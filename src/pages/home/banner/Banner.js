...
function Banner() {
    ...
    const styles = {
        ...
        bannerCol: {width: 'calc(100%/3)', height: '100%', margin: '0 2.5px'},
        bannerHalfCol: {width: 'calc(100%/6)', height: '100%', margin: '0 2.5px'},
        bannerImg: {width: '100%', height: '100%', objectFit: 'cover'},
        bannerTopSmImg: {width: '100%', height: '50%', objectFit: 'cover', paddingBottom: '2.5px'},
        bannerBottomSmImg: {width: '100%', height: '50%', objectFit: 'cover', paddingTop: '2.5px'}
    }
