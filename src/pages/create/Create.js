    ...
    return(
        <div style={{height:'100%', position:'relative'}} className="createNftCover">
            ...
            <div className="mobile">
                <div style={styles.mobileCreateCover}>
                    <div style={{}}>
                        <p style={styles.title}>Preview Item</p>
                        {
                            imgFile == null ?
                            <img src={alterImg} alt="preview image" style={styles.mobilePreviewImg}></img>
                            :
                            <img src={URL.createObjectURL(imgFile)} alt="preview image" style={styles.mobilePreviewImg}></img>
                        }
                    </div>
                    <div style={{}}>
                        <form onSubmit={handleSubmit}>
